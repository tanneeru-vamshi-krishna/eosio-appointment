...
class UISappoint:public contract{
    ...
    private:
        ...
        struct uishospapp{
            ...
            EOSLIB_SERIALIZE(uishospapp, (created_by)(created_at) (doctor_ID)(doctor_ID_str) (appointment_ID_str) (appointment_ID) (start_time) (end_time) (patient_ID) (patient_ID_str) (status)(cancelled_by)(cancelled_at)(terminated_by)(terminated_at))
        };
